...
public class OpenCameraActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        mCameraView.takePicture(new FilteredBitmapCallback() {
            ...
            public void onData(Bitmap bitmap) {
                ...
                try {
                    ...
                    Toast.makeText(OpenCameraActivity.this, "已保存", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    private void onRecord() {
        ...
        if (mRecordingEnabled) {
            Toast.makeText(OpenCameraActivity.this, "开始", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(OpenCameraActivity.this, "完成", Toast.LENGTH_SHORT).show();
        }
    }
}